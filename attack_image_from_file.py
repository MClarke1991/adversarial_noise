...
def main() -> None:
    ...
    parser.add_argument(
        "--output", type=str, help="Path to save output image", default=None
    )
    parser.add_argument(
        "--alpha", type=float, default=0.02, help="Step size for attack"
    )
    parser.add_argument("--num-iter", type=int, default=10, help="Number of iterations")
    parser.add_argument(
        "--model", type=str, default="microsoft/resnet-34", help="Model name"
    )
    parser.add_argument(
        "--verbose",
        default=True,
